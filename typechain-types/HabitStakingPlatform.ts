...
export interface HabitStakingPlatformInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "challenges"
      | "claimPointsForHabit"
...
export interface HabitStakingPlatform extends BaseContract {
  connect(runner?: ContractRunner | null): HabitStakingPlatform;
  waitForDeployment(): Promise<this>;

  interface: HabitStakingPlatformInterface;
